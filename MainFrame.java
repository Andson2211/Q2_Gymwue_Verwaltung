...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        setBounds(100, 150, 800, 270); // 400 + 260               //Eigenschaften (z.B. Größe des GUIs) 
         ...
         gebDatField = new JTextField();                         //Geburtsdatum als Überschrift erzeugen + Eigenschaften     
        ...
        editButton.setBounds(140, 190, 120, 25);                 //Eigenschaften des Buttons (z.B. Größe)
